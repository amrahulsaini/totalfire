...
export const storeProducts: StoreProduct[] = [
  ...
  {
    slug: "spark-lite-earphones",
    name: "Spark Lite Wired Earphones",
    category: "Peripherals",
    price: 25,
    mrp: 49,
    rating: 4.2,
    ...
    badge: "Budget Pick",
    heroLabel: "₹25 Deal",
    shortDescription: "Ultra-low-cost wired earphones for casual matches, Discord calls, and backup gaming audio.",
    description: "Spark Lite is a pocket-friendly backup audio option for players who want a simple wired solution without spending big. Great for quick practice sessions and emergency tournament setups.",
    features: [
      "3.5 mm universal jack",
      "Inline mic and call button",
      "Lightweight travel-friendly build",
      "Low-cost backup for gaming sessions",
    ],
    specs: [
      "Connection: 3.5 mm",
      "Cable Length: 1.2 m",
      "Mic: Inline single mic",
      "Color: Black/Red",
    ],
    imageUrl: "/new-frontned/headset-onlyh.png",
  },
  {
    slug: "frost-mini-cooling-pad",
    name: "Frost Mini Phone Cooling Pad",
    category: "Peripherals",
    price: 50,
    mrp: 99,
    rating: 4.3,
    ...
    badge: "Hot Deal",
    heroLabel: "₹50 Deal",
    shortDescription: "Compact stick-on phone cooling pad built for light BGMI and Free Fire sessions on a budget.",
    description: "Frost Mini helps reduce hand heat and gives your phone a more comfortable grip during fast matches. It is an easy add-on for players who want a cheap cooling accessory in their kit.",
    features: [
      "Lightweight snap-on form factor",
      "Pocket-size for travel setups",
      "Comfortable grip while playing",
      "Made for low-budget loadouts",
    ],
    specs: [
      "Type: Passive cooling pad",
      "Weight: 32 g",
      "Fit: Universal phone clip",
      "Use Case: Casual gaming",
    ],
    imageUrl: "/new-frontned/mouse-only.png",
  },
  {
    slug: "frost-pro-cooling-pad",
    name: "Frost Pro Phone Cooling Pad",
    category: "Peripherals",
    price: 75,
    mrp: 149,
    rating: 4.4,
    ...
    badge: "Starter Pack",
    heroLabel: "₹75 Deal",
    shortDescription: "Upgraded mobile cooling pad with stronger grip and better comfort for longer ranked sessions.",
    description: "Frost Pro is a slightly more stable option for players who need better hand comfort and steadier grip during extended gameplay. It is positioned as the next step up from Frost Mini while staying affordable.",
    features: [
      "Improved grip stability",
      "Cooling surface for longer sessions",
      "Quick clip-on installation",
      "Affordable ranked-play accessory",
    ],
    specs: [
      "Type: Passive cooling pad",
      "Weight: 40 g",
      "Fit: Universal phone clip",
      "Use Case: Ranked and scrims",
    ],
    imageUrl: "/new-frontned/mouse-only.png",
  }
];
